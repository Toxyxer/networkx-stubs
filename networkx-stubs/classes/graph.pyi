...
from typing import Any, Optional, Generic, Tuple, TypeVar, Iterator, Dict, Iterable, Set
...
class Graph(Generic[T]):
    ...
    def __len__(self): ...
    def __getitem__(self, n: T) -> Set[T]: ...
    ...
    def neighbors(self, n: T) -> Iterable[T]: ...
    @property
